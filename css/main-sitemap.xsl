<?xml version="1.0" encoding="UTF-8"?>
	<xsl:stylesheet version="2.0"
		...
		xmlns:links="https://christophkhouri.com/schemas/links"
			...
			<xsl:if test="count(sitemap:sitemapindex/sitemap:sitemap) &lt; 1">
				...
				<table id="sitemap" cellpadding="3">
					...
					<tr>
						...
						<th width="10%">Internal Links</th>
						<th width="10%">External Links</th>
					...
					<xsl:for-each select="sitemap:urlset/sitemap:url">
						<tr>
							...
							<td>
								<xsl:choose>
									<xsl:when test="links:internal">
										<xsl:value-of select="links:internal"/>
									</xsl:when>
							...
							<td>
								<xsl:choose>
									<xsl:when test="links:external">
										<xsl:value-of select="links:external"/>
									</xsl:when>
									<xsl:otherwise>-</xsl:otherwise>
								</xsl:choose>
							</td>
